...
现在考虑第9游戏刻，此时矿车已经驶出弯轨，此时向$z$方向的投影只是单纯地消除$x$方向的位移，所以$r_x=0.5$。速度方面，将速度向量旋转到 $+z$方向，得到$0.259447=\sqrt{2}\times0.183457$，驶出弯轨的校正工作完成。
